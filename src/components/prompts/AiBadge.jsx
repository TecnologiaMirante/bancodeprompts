...
export const AI_CONFIG = {
  ChatGPT: {
    ...
    bg: "#10a37f15",
    label: "ChatGPT",
    Icon: createIcon(SiOpenai),
  },
  Claude: {
    color: "#cc6b2c",
    bg: "#cc6b2c15",
    label: "Claude",
    Icon: createIcon(SiClaude),
  },
  Gemini: {
    color: "#4285f4",
    bg: "#4285f415",
    label: "Gemini",
    Icon: createIcon(SiGooglegemini),
  },
  Perplexity: {
    color: "#7c3aed",
    bg: "#7c3aed15",
    label: "Perplexity",
    Icon: createIcon(SiPerplexity),
  },
  DeepSeek: {
    color: "#4D6BFE",
    bg: "#4D6BFE15",
    label: "DeepSeek",
    Icon: createIcon(DeepSeekIcon),
  },
  Copilot: {
    color: "#6366f1",
    bg: "#6366f115",
    label: "Copilot",
    Icon: createIcon(SiGithubcopilot),
  },
};

/* ── Badge component ─────────────────────────────────────────── */
export default function AiBadge({ ai, size = "sm" }) {
